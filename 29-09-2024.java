...
public class Habitante {
    ...
    public static void main(String[] args) {
        ...
        habitante1.setDatos("Franco", "Antunez", "Castro");
...
public class Habitante2 {
    ...
    public static void main(String[] args) {
        ...
        habitante2.setDatos("Franco", "Antunez", "Castro");
        // Imprimir el nombre completo
...
public class Habitante3 {
    ...
    public static void main(String[] args) {
        ...
        habitante3.setDatos("Franco", "Antunez", "Castro");
...
public class Habitante4 {
    ...
    public static void main(String[] args) {
        // Crear una instancia de Habitante
        Habitante4 habitante4 = new Habitante4("Franco", "Antunez", "Castro");
